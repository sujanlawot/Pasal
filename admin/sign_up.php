...
<link rel="stylesheet" href="css/signup.css">
  ...
  <body>
    ...
    <div class="form">
      <h2 class="heading">Sub-Administrator Register Form</h2>
      <form name="signup" method="post" action="act.php" onsubmit="return a()">
        ...
        <div class="signup2">
          <input type="password" name="password" value="" placeholder="Atleast 8 character">
        </div>
        <div class="signup1">
        ...
        <div class="button_sign">
          <input type="submit" name="register" value="Create your account" class="btn">
        </div>
      </form>
      <div class="a">
